const PAPER=Object.assign({
  ...
  places:{
    ...
    Brig:["img/ch/brig.jpg"],
    Andermatt:["img/ch/andermatt.jpg"],
    Martigny:["img/ch/martigny.jpg"],
    Aigle:["img/ch/aigle.jpg"],
    Montreux:["img/chillon.jpg","img/lavaux.jpg"],
    Lausanne:["img/ch/lausanne.jpg"],
    Genève:["img/ch/geneva.jpg","img/lavaux.jpg"],
    Geneva:["img/ch/geneva.jpg","img/lavaux.jpg"],
    Sion:["img/ch/sion.jpg"],
    Basel:["img/basel.jpg","img/rheinfall.jpg"],
    Schaffhausen:["img/ch/schaffhausen.jpg"],
    "Rhine Falls":["img/rheinfall.jpg"],
    "Stein am Rhein":["img/ch/steinamrhein.jpg"],
    Luzern:["img/lucerne.jpg"],
    Lucerne:["img/lucerne.jpg"],
    Schwyz:["img/ch/schwyz.jpg"],
    Einsiedeln:["img/ch/einsiedeln.jpg"],
    Brunnen:["img/ch/brunnen.jpg"],
    Interlaken:["img/ch/interlaken.jpg"],
    Chur:["img/ch/chur.jpg"],
    "St. Moritz":["img/engadin.jpg"],
    Müstair:["img/ch/muestair.jpg"],
    Rorschach:["img/ch/rorschach.jpg"],
    Romanshorn:["img/ch/romanshorn.jpg"],
    Murten:["img/murten.jpg"],
    "Biel/Bienne":["img/ch/biel.jpg"],
    Biel:["img/ch/biel.jpg"],
    Lugano:["img/lugano.jpg"],
    Bellinzona:["img/ch/bellinzona.jpg","img/gotthard.jpg"],
    Zürich:["img/ch/zurich.jpg"],
    Zug:["img/ch/zug.jpg"],
    Olten:["img/ch/olten.jpg"],
    "St. Gallen":["img/ch/stgallen.jpg"],
    "Neuchâtel":["img/ch/neuchatel.jpg"],
    Rapperswil:["img/ch/rapperswil.jpg"],
    Meiringen:["img/ch/meiringen.jpg"],
    "Yverdon-les-Bains":["img/ch/yverdon.jpg"],
    Sargans:["img/ch/sargans.jpg"],
    Zernez:["img/ch/zernez.jpg"],
    "Évian-les-Bains":["img/ch/evian.jpg"],
    "Thonon-les-Bains":["img/ch/thonon.jpg"],
    Bregenz:["img/ch/bregenz.jpg"],
    Lindau:["img/ch/lindau.jpg"],
    Friedrichshafen:["img/ch/friedrichshafen.jpg"],
    Bern:["img/ch/bern.jpg"],
    Thun:["img/ch/thun.jpg"],
    Spiez:["img/ch/spiez.jpg"],
    Winterthur:["img/ch/winterthur.jpg"],
    Solothurn:["img/aare.jpg"],
    Aarau:["img/ch/aarau.jpg"],
    Fribourg:["img/ch/fribourg.jpg"],
    Davos:["img/ch/davos.jpg"],
    Altstätten:["img/ch/altstaetten.jpg"],
    Appenzell:["img/ch/appenzell.jpg"],
    Beckenried:["img/ch/beckenried.jpg"],
    Bulle:["img/ch/bulle.jpg"],
    Burgdorf:["img/ch/burgdorf.jpg"],
    Gersau:["img/ch/gersau.jpg"],
    Herisau:["img/ch/herisau.jpg"],
    "Langnau im Emmental":["img/ch/langnau.jpg"],
    Laufenburg:["img/ch/laufenburg.jpg"],
    Nyon:["img/ch/nyon.jpg"],
    Radolfzell:["img/ch/radolfzell.jpg"],
    Romont:["img/ch/romont.jpg"],
    "Sainte-Croix":["img/ch/saintcroix.jpg"],
    "San Bernardino":["img/ch/sanbernardino.jpg"],
    Sarnen:["img/ch/sarnen.jpg"],
    "St. Margrethen":["img/ch/stmargrethen.jpg"],
    Stans:["img/ch/stans.jpg"],
    Sustenpass:["img/ch/sustenpass.jpg"],
    Sörenberg:["img/ch/soerenberg.jpg"],
    Thusis:["img/ch/thusis.jpg"],
    Tiefencastel:["img/ch/tiefencastel.jpg"],
    Vallorbe:["img/ch/vallorbe.jpg"],
    Wattwil:["img/ch/wattwil.jpg"],
    "Wil SG":["img/ch/wil.jpg"],
    Willisau:["img/ch/willisau.jpg"],
    Zweisimmen:["img/ch/zweisimmen.jpg"],
    Überlingen:["img/ch/ueberlingen.jpg"],
    Airolo:["img/ch/airolo.jpg"],
    "Flüelen":["img/ch/flueelen.jpg"],
    Altdorf:["img/ch/altdorf.jpg"],
    Glarus:["img/ch/glarus.jpg"],
    Locarno:["img/ch/locarno.jpg"],
    Baden:["img/ch/baden.jpg"],
    Brugg:["img/ch/brugg.jpg"],
    Gstaad:["img/ch/gstaad.jpg"],
    "Château-d'Œx":["img/ch/chateaudoex.jpg"],
    Delémont:["img/ch/delemont.jpg"],
    "La Chaux-de-Fonds":["img/ch/lachaux.jpg"],
    "Disentis/Mustér":["img/ch/disentis.jpg"],
    Sierre:["img/ch/sierre.jpg"],
    Kandersteg:["img/ch/kandersteg.jpg"],
    Wassen:["img/ch/wassen.jpg"],
    Laupen:["img/ch/laupen.jpg"],
    Göschenen:["img/ch/goeschenen.jpg"],
    Kreuzlingen:["img/ch/kreuzlingen.jpg"],
    Koblenz:["img/ch/koblenz.jpg"]
  },
  en:{"Genève":"Geneva","Luzern":"Lucerne","Basel":"Basle","Bern":"Berne","Sankt Gallen":"St. Gallen","Zürich":"Zurich"},
